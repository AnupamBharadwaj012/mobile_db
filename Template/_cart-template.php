...
//    print_r($ud);
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if (isset($_POST['purchase'])){
            $query = "delete from cart where user_id = $ud";
            $result = mysqli_query($connect, $query);
            if (mysqli_query($connect, $query)) {
                header("location:index.php?purchased");
            }
        }
    }
...
<section id="cart" class="py-3 mb-5">
    <div class="container-fluid w-75">
        ...
        <div class="row">
            <div class="col-sm-9">
                <?php
                    foreach ($product->getUserCart($uid['user_id']) as $item) :
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="qty d-flex pt-2">
                            ...
                            <form method="post">
                                <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                                <button type="submit" name="wishlist-submit" class="btn font-baloo text-info">Save for Later</button>
                            </form>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        ...
                        <form method="post">
                            <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                            <button type="submit" name="purchase" class="btn font-baloo text-warning ">Purchase</button>
                        </form>
